...
class MainMenuPage(startButtonOnClick : ((Int,Int) -> Unit)) : LayoutBox(Relative(1f), Relative(1f), Center(), Center()) {
    ...
    init {
        children = listOf(
            ...
            SelectBox("a", listOf("a","b","c"), PixelWidth(160), PixelHeight(40), PixelLeft(40), PixelTop(40), cornerRadius = 5 , innerElement =
                Text("",7f, StaticResources.standardFont,30f,TextMode.Left, true, Center(), Center())
            ),
        )
