...
class PixelRight(pixel : Int) : ITranslateConstraint, PixelConstraint(pixel) {
    ...
    override fun getTranslate(guiElement: GuiElement): Float {
        ...
        return -guiElement.widthConstraint.getScale(guiElement) + 1f - (pixel / windowPixel.toFloat() * 2f * (1/parentScale))
    }
