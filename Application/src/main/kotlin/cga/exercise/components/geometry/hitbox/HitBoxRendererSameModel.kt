...
class HitBoxRendererSameModel(override var hitboxes : MutableList<HitBox> = mutableListOf()) : IHitBoxRenderer {
...
//7        1f,1f,-1f,
    ...
    private val mesh : Mesh = Mesh(vertexData, indexData, arrayOf(VertexAttribute(3,GL32.GL_FLOAT,0,0)),null)
...
//        GL32.glPointSize(10f)
        ...
        hitboxes.forEachIndexed { index, it ->
            shaderProgram.setUniform("collision_in", if(it.collided.get()) 1f else 0f)
            shaderProgram.setUniform("model_matrix", it.getWorldModelMatrix(), false)
